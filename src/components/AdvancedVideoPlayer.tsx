...
export function AdvancedVideoPlayer({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="video-player-dialog bg-black border-0 [&>button]:text-white [&>button]:hover:bg-white/20 [&>button]:z-[60]"
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          ...
          {/* Video Controls */}
          <div 
            className={`absolute inset-0 w-full h-full bg-gradient-to-t from-black/80 via-transparent to-black/40 transition-opacity duration-300 z-50 pointer-events-none ${
              showControls ? 'opacity-100' : 'opacity-0'
            }`}
          >
            {/* Top Controls */}
            <div className="absolute top-0 left-0 right-0 p-4 sm:p-6 flex justify-between items-start z-[60] pointer-events-auto">
            ...
            {/* Bottom Controls */}
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 space-y-2 sm:space-y-4 z-[60] pointer-events-auto">
              {/* Progress Bar */}
              {duration > 0 && (
                <Slider
                  value={[currentTime]}
